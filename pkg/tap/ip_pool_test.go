...
func TestIPPool(t *testing.T) {
	...
	assert.Equal(t, map[string]string{"10.0.0.1": "1", "10.0.0.2": "2"}, pool.Leases())

	pool.Release("1")

	assert.Equal(t, map[string]string{"10.0.0.2": "2"}, pool.Leases())
	...
	assert.Equal(t, map[string]string{"10.0.0.1": "3", "10.0.0.2": "2", "10.0.0.3": "4"}, pool.Leases())
}
